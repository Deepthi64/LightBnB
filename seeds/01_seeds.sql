...
VALUES 
    ...
    ('2023-06-12', '2023-06-17', 2, 3),
    ('2023-07-05', '2023-07-10', 3, 1);

INSERT INTO property_reviews (guest_id, property_id, reservation_id, rating, message)
VALUES 
    (2, 1, 1, 4, 'Great property, had an amazing time!'),
    (3, 2, 2, 5, 'This place was even better than we expected.'),
    (1, 3, 3, 3, 'Good location, but could use some improvements.');
